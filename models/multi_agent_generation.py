...
class MultiAgentModel(CodeGenerationModel):
    ...
    def __init__(
        ...
        self._keep_generated_function_signature = keep_generated_function_signature
        ...
        for i in range(self._max_iterations):
            ...
            try:
                feedback_list, details, successes = self._reviewer.generate_feedback(
                    prompt,
                    "" if self._keep_generated_function_signature else declaration, 
                    current_raw_code, 
                    entry_point,
                    n=1
                )
            ...
            try:
                # If keep_generated_function_signature is True, don't combine with declaration 
                ...
                if self._keep_generated_function_signature:
                    ...
                    # TODO: this doesn't actually remove the function signature, only imports
...
def create_multi_agent_model(
    ...
    Args:
        ...
        keep_generated_function_signature: If True, use entire implementation with function signatures
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--keep_generated_function_signature", action="store_true", default=False,
